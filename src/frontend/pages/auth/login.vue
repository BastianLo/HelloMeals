  ...
  <section class="bg-gray-50 dark:bg-gray-900">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
        <img class="w-8 h-8 mr-2" src="/512px.png"
             alt="logo">
        HelloMeals
      </a>
      <div
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form class="flex flex-col space-y-4 md:space-y-6 items-center" @submit.prevent="login">
            ...
            <button type="submit"
                    class="w-fit justify-self-center text-gray-900 border-gray-300 border bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 dark:text-white">
              {{ $t('auth.login') }}
            </button>
          </form>
        </div>
